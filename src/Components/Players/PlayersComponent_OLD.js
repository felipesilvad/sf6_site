...
function PlayersComponent() {
  ...
  return (
    <Container className='player-min-h'>
      <Row>
        <Col>
          <h5 className='ardela txt-shadow mt-1 text-center'>Players</h5>
          <Select
        ...
        {/* <Col md={selectedPlayer2&&(3)}>
          <h5 className='ardela txt-shadow mt-1 text-center'>VS Player</h5>
          <Select
